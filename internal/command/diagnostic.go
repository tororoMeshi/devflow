...
const (
	...
	CodeInvalidExecutionReport           = "error_invalid_execution_report"
	CodeUnsupportedExecutionReportSchema = "error_unsupported_execution_report_schema"
	CodeExecutionReportTooLarge          = "error_execution_report_too_large"
	CodeUnknownExecutionReportField      = "error_unknown_execution_report_field"
	CodeTrailingExecutionReportJSON      = "error_trailing_execution_report_json"
	CodeExecutionReportRunMismatch       = "error_execution_report_run_mismatch"
	CodeWorkPackageBindingMismatch       = "error_work_package_binding_mismatch"
	CodeUnknownEvidenceReference         = "error_unknown_evidence_reference"
	CodeUnknownArtifactReference         = "error_unknown_artifact_reference"
	CodeUnsafeExecutionReportStore       = "error_unsafe_execution_report_store"
	CodeInvalidExistingExecutionReport   = "error_invalid_existing_execution_report"
	CodeConflictingExecutionReport       = "error_conflicting_execution_report"
	CodeExecutionReportSaveFailed        = "error_execution_report_save_failed"
)
